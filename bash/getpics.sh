...
# creating a picture directory, supposing we have home directory, if we do not have one and downloading the tgz from zonzorp
...
# downloading a tar file of pictures to picture directory if there's nothing to extract
#unpacking of tar file, after this deleting the local copy of zip file
